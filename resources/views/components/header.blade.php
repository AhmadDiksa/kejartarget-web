<header class="bg-white/70 backdrop-blur-md shadow-sm sticky top-0 z-50">
    <div class="container mx-auto px-6 py-4 flex justify-between items-center">
                ...
                <nav class="hidden md:flex items-center space-x-8 text-sm font-semibold tracking-wider">
                    ...
                    <a href="#" class="hover:text-green-400 transition-colors">ABOUT</a>
                    <a href="#" class="hover:text-green-400 transition-colors">PUBLICATION</a>
                </nav>
                ...
                <div class="hidden md:flex items-center space-x-6">
                    ...
                    <a href="#" class="bg-green-500 text-white px-6 py-2 rounded-md text-sm font-semibold hover:bg-green-600 transition-colors">
                        CONTACT US
                    </a>
                </div>
            </div>
