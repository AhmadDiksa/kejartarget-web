...
{{-- HAPUS section#portfolio YANG LAMA DAN GANTI DENGAN INI --}}
    ...
    <div class="container mx-auto px-6">
        ...
        <div class="text-center max-w-3xl mx-auto">
            ...
            <p data-aos="fade-up" data-aos-delay="200" class="text-gray-600">
                Mulai perjalanan Event yang tak terlupakan bersama Event Organizer (EO) Terbaik di Indonesia, Eventify. Portofolio kami adalah bukti nyata dari dedikasi, kreativitas, dan semangat yang kami hadirkan dalam setiap acara.
            </p>
        </div>
...
{{-- Trusted By Section End --}}
 ...
 {{-- HAPUS section#testimonials YANG LAMA DAN GANTI DENGAN INI --}}
